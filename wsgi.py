...
def womens_page():
  ...
  query3 = " AND s.CATALOGUE_CATEGORY IN (53102901,53101603,53103201,53101904) AND s.DESCRIPTION LIKE '%Women%'"
...
def mens_page():
  ...
  query1 = "SELECT s.ITEM_NUMBER, s.DESCRIPTION,s.LONG_DESCRIPTION, s.SKU_ATTRIBUTE_VALUE1,s.SKU_ATTRIBUTE_VALUE2,p.LIST_PRICE,p.DISCOUNT"
  query2 = " FROM XXIBM_PRODUCT_SKU s INNER JOIN XXIBM_PRODUCT_PRICING p WHERE s.ITEM_NUMBER=p.ITEM_NUMBER"
  query3 = " AND s.CATALOGUE_CATEGORY IN (53102902,53102901,53103201,53103101,53101902) AND s.DESCRIPTION LIKE '%[!Wo]Men%'"
